...
if __name__ == '__main__':
    ...
    model.trans.save('/home/Attack_sc/models/CIFAR-classification-task/trans', save_format='tf')
    model.recive.save('/home/Attack_sc/models/CIFAR-classification-task/recive', save_format='tf')
