...
if __name__ == '__main__':
    ...
    for epoch in range(50):
        for step, x in enumerate(train_db):
            ...
            save.to_csv('/home/Attack_sc/models_budget/log-for_m%s.csv' % m)
    ...
    model.encoder.save('/home/Attack_sc/models_budget/CIFAR-classification-task-for_m%s/channel_encoder' % m,
                       save_format='tf')
    model.decoder.save('/home/Attack_sc/models_budget/CIFAR-classification-task-for_m%s/channel_decoder' % m,
                       save_format='tf')

    E = load_model('/home/Attack_sc/models_budget/CIFAR-classification-task-for_m%s/channel_encoder' % m)
    E.trainable = False
    D = load_model('/home/Attack_sc/models_budget/CIFAR-classification-task-for_m%s/channel_decoder' % m)
    D.trainable = False
